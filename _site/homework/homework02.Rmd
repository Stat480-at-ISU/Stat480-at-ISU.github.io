...
5. For your subset, compute the average  of `share_women` and its standard deviation. Also compute the average mean earnings (`median`) and its standard deviation. Comment on the results. (You might have to deal with missing values appropriately).
