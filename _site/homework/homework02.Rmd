...
6. Use the original dataset and `ggplot2` to draw a scatterplot of share of total and the median earnings. Color points by the major category (`major_category`). Comment on the result. 
