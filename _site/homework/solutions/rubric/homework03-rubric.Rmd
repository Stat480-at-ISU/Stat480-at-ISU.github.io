...
Example interpretation: This data set contains 13 variables and 32,833 observations. Of the 13 variables, 3 are of type `factor`, 1 of type `integer`, and the rest of `numeric`.
:::

:::rubric
+2pt total  
+1pt if they have any one of the above  
+1pt for interpretation  
:::
