...
:::rubric
+1 pt total:  
+0.5 pt for number of sales  
+0.5 pt for variable descriptions  
:::
...
**Example comment**: Mean sales prices range from \$94,000 to \$310,000, with NridgHt and NoRidge having mean sales prices over \$300,000. It appears that around half of neighborhoods have mean sales prices below \$150,000.
:::

:::rubric
+3.5 pts total:  
+0.5 pt for attempting question  
+0.5 pt for adding variable for price per square foot  
+0.5 pt for calculating average price per square foot in each of the Ames neighborhoods  
+0.5 pt for filtering  
+0.5 pt for reordering  
+0.5 pt for graphic  
+0.5 pt for comment  

+0.5 EXTRA CREDIT if code in single line similar to my example.
:::
